...
REM
REM Generated by Vivado on Sat Dec 27 19:18:10 +0530 2025
...
echo "xvlog --incr --relax -prj tb_UART_FullLoop_vlog.prj"
call xvlog  --incr --relax -prj tb_UART_FullLoop_vlog.prj -log xvlog.log
