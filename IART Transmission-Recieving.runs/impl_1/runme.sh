...
HD_PWD='C:/Users/shrey/UART Transmission-Recieving/IART Transmission-Recieving.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Top_UART_Module.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Top_UART_Module.tcl -notrace
