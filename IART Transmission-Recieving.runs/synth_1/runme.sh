...
HD_PWD='C:/Users/shrey/UART Transmission-Recieving/IART Transmission-Recieving.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Top_UART_Module.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Top_UART_Module.tcl
